...
function dataTable(arr = table.results) {
	arr.forEach(function(element) {
		...
		var rotation_period = document.createElement("td");
		rotation_period.append(element.rotation_period);
		var orbital_period = document.createElement("td");
		orbital_period.append(element.orbital_period);
		...
		var terrain = document.createElement("td");
		terrain.append(element.terrain);
		var surface_water = document.createElement("td");
		...
		var films = document.createElement("td");
		...
		tr.append(name, rotation_period, orbital_period, diameter, climate, gravity, terrain, surface_water, population, residents, films, created, edited, url);
		parent.append(tr);
	});
}
